...
export const metadata: Metadata = {
  metadataBase: new URL("https://vortech-building-solutions.vercel.app"),
  title: {
    default: `${siteConfig.companyName} | Automatización, control y tratamiento de agua`,
    template: `%s | ${siteConfig.shortName}`,
  },
  description:
    "Landing corporativa premium para automatización de edificios, PLC, medición de utilities, tratamiento de agua y dashboards cloud.",
  keywords: [
