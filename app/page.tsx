      ...
      <main id="inicio" className="overflow-hidden">
          ...
          <div className="container-shell grid items-center gap-12 pb-20 lg:grid-cols-[1.02fr_.98fr] lg:pb-28">
            <Reveal>
              <div className="max-w-3xl">
                <span className="section-eyebrow">VORTECH · Control · Agua · Datos</span>
        ...
        <section id="contacto" className="container-shell scroll-mt-28 py-20">
          <div className="grid gap-10 lg:grid-cols-[.85fr_1.15fr]">
            ...
            <Reveal>
              <form action="/api/contact" method="post" className="glass-panel grid gap-5 rounded-[2rem] p-6 sm:grid-cols-2 sm:p-8" aria-label="Formulario de contacto">
                {[
                  ["Nombre", "name", "text"],
                ...
                <div className="sm:col-span-2">
                  <button type="submit" className="cta-button w-full bg-cyanx text-slate-950 shadow-glow hover:bg-white sm:w-auto">
                    Enviar solicitud
                  </button>
      ...
      <footer className="border-t border-white/10 py-10">
        <div className="container-shell grid gap-8 md:grid-cols-4">
          <div className="md:col-span-2">
            <BrandLogo />
            <p className="mt-4 max-w-md text-sm leading-6 text-slate-400">{siteConfig.companyName} — automatización, control industrial, tratamiento de agua y medición inteligente de utilities.</p>
          </div>
          <div>
